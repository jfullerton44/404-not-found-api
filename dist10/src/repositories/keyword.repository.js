...
let KeywordRepository = class KeywordRepository extends repository_1.DefaultCrudRepository {
    constructor(datasource) {
        super(keyword_1.Keyword, datasource);
        this.datasource = datasource;
    }
};
KeywordRepository = __decorate([
